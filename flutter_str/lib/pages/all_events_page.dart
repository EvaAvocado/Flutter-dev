...
import 'package:flutter_str/pages/event_page.dart';
...
class AllEvents extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var characters = EventHive().getAll()!.toList();
    print(characters);
    List<EventWidget> characterWidgets = [];
    characters.forEach((element) {
      characterWidgets.add(EventWidget(event: element));
    });
    return new Scaffold(
      body: Stack(
        children: [
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (BuildContext context) => CurrentEvent()),
                    ModalRoute.withName('/')
                );
              },
            ),
