...
import '../components/character_widget.dart';
import 'character_page.dart';

class AllCharacters extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var characters = CharacterHive().getAll()!.toList();
    print(characters);
    List<CharacterWidget> characterWidgets = [];
    characters.forEach((element) {
      characterWidgets.add(CharacterWidget(character: element));
    });
    return new Scaffold(
      body: Stack(
        children: [
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.pushAndRemoveUntil(
                    context,
                    MaterialPageRoute(builder: (BuildContext context) => CurrentCharacter()),
                    ModalRoute.withName('/')
                );
              },
            ),
