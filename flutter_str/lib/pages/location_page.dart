...
import 'package:flutter_str/pages/all_locations_page.dart';

import '../entity/location.dart';
import '../hive_manager/hive_manager.dart';

class CurrentLocation extends StatefulWidget {
  CurrentLocation({Key? key, this.location}) : super(key: key);
  final location;
